...
const OverdueCharge = ({ book, onBookPress }) => {
  return (
    <TouchableOpacity onPress={() => onBookPress(book)}>
      <View style={styles.bookItem}>
        ...
        <View style={styles.bookCard}>
          ...
          <Text style={styles.bookLanguage}>Charge: Rs.20.00</Text>
        </View>
        {book.overDue && (
          <View style={styles.overdueLabelContainer}>
            <Text style={styles.overdueLabel}>2 Days</Text>
          </View>
        )}
      </View>
    </TouchableOpacity>
